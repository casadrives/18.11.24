...
export const EMAIL_CONFIG = {
  ...
  FROM_EMAIL: 'noreply@casadrives.com',
};
...
export const emailService = {
  ...
  async sendSubscriptionNotification(subscriptionData: { 
    ...
    await this.sendEmail({
      ...
      html: `
        ...
        <ul>
          ...
          <li><strong>Amount:</strong> €${subscriptionData.amount.toFixed(2)}</li>
          <li><strong>Start Date:</strong> ${new Date(subscriptionData.startDate).toLocaleDateString()}</li>
          <li><strong>End Date:</strong> ${new Date(subscriptionData.endDate).toLocaleDateString()}</li>
        </ul>
        <p>Please review the subscription details in the admin dashboard.</p>
      `
    });
    ...
    await this.sendEmail({
      ...
      subject: 'CasaDrive Subscription Confirmation',
      html: `
        <h2>Subscription Confirmation</h2>
        <p>Thank you for subscribing to CasaDrive!</p>
